...
export const UPGRADE_LOCKED_STAKE_DISCRIMINATOR = new Uint8Array([
  151, 103, 128, 107, 112, 115, 67, 172,
]);

export function getUpgradeLockedStakeDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    UPGRADE_LOCKED_STAKE_DISCRIMINATOR
  );
}

export type UpgradeLockedStakeInstruction<
...
export type UpgradeLockedStakeInstructionData = {
  discriminator: ReadonlyUint8Array;
  lockedStakeId: bigint;
  amount: Option<bigint>;
  lockedDays: Option<number>;
};

export type UpgradeLockedStakeInstructionDataArgs = {
  lockedStakeId: number | bigint;
  amount: OptionOrNullable<number | bigint>;
  lockedDays: OptionOrNullable<number>;
};

export function getUpgradeLockedStakeInstructionDataEncoder(): Encoder<UpgradeLockedStakeInstructionDataArgs> {
  return transformEncoder(
    getStructEncoder([
      ['discriminator', fixEncoderSize(getBytesEncoder(), 8)],
      ['lockedStakeId', getU64Encoder()],
      ['amount', getOptionEncoder(getU64Encoder())],
      ['lockedDays', getOptionEncoder(getU32Encoder())],
    ]),
    (value) => ({ ...value, discriminator: UPGRADE_LOCKED_STAKE_DISCRIMINATOR })
  );
}

export function getUpgradeLockedStakeInstructionDataDecoder(): Decoder<UpgradeLockedStakeInstructionData> {
  return getStructDecoder([
    ['discriminator', fixDecoderSize(getBytesDecoder(), 8)],
    ['lockedStakeId', getU64Decoder()],
    ['amount', getOptionDecoder(getU64Decoder())],
    ['lockedDays', getOptionDecoder(getU32Decoder())],
  ]);
}

export function getUpgradeLockedStakeInstructionDataCodec(): Codec<
  UpgradeLockedStakeInstructionDataArgs,
  UpgradeLockedStakeInstructionData
> {
  return combineCodec(
    getUpgradeLockedStakeInstructionDataEncoder(),
    getUpgradeLockedStakeInstructionDataDecoder()
  );
}

export type UpgradeLockedStakeInput<
...
> = {
  ...
  lockedStakeId: UpgradeLockedStakeInstructionDataArgs['lockedStakeId'];
  amount: UpgradeLockedStakeInstructionDataArgs['amount'];
  lockedDays: UpgradeLockedStakeInstructionDataArgs['lockedDays'];
};

export function getUpgradeLockedStakeInstruction<
  TAccountOwner extends string,
  TAccountFundingAccount extends string,
  TAccountRewardTokenAccount extends string,
  TAccountLmTokenAccount extends string,
...
> {
  ...
  const instruction = {
    ...
    programAddress,
    data: getUpgradeLockedStakeInstructionDataEncoder().encode(
      args as UpgradeLockedStakeInstructionDataArgs
    ),
  } as UpgradeLockedStakeInstruction<
    TProgramAddress,
    TAccountOwner,
    TAccountFundingAccount,
    TAccountRewardTokenAccount,
...
export type ParsedUpgradeLockedStakeInstruction<
  TProgram extends string = typeof ADRENA_PROGRAM_ADDRESS,
...
> = {
  ...
  accounts: {
    ...
    governanceRealm: TAccountMetas[15];
    /** #17 */
    governanceRealmConfig: TAccountMetas[16];
    /**
     * #18
     * Token account owned by governance program holding user's locked tokens
     */

    governanceGoverningTokenHolding: TAccountMetas[17];
    /**
     * #19
     * Account owned by governance storing user information
     */

    governanceGoverningTokenOwnerRecord: TAccountMetas[18];
    /** #20 */
    stakingLmRewardTokenVault: TAccountMetas[19];
    /** #21 */
    adrenaProgram: TAccountMetas[20];
    /** #22 */
  ...
  data: UpgradeLockedStakeInstructionData;
};

export function parseUpgradeLockedStakeInstruction<
...
>(
  instruction: IInstruction<TProgram> &
    ...
    IInstructionWithData<Uint8Array>
): ParsedUpgradeLockedStakeInstruction<TProgram, TAccountMetas> {
  ...
  return {
    ...
    data: getUpgradeLockedStakeInstructionDataDecoder().decode(
      instruction.data
    ),
  };
}
