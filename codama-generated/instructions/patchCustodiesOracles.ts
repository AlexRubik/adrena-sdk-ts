...
export const PATCH_CUSTODIES_ORACLES_DISCRIMINATOR = new Uint8Array([
  150, 248, 194, 18, 193, 152, 67, 25,
]);

export function getPatchCustodiesOraclesDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    PATCH_CUSTODIES_ORACLES_DISCRIMINATOR
  );
}

export type PatchCustodiesOraclesInstruction<
...
export type PatchCustodiesOraclesInstructionData = {
  discriminator: ReadonlyUint8Array;
};

export type PatchCustodiesOraclesInstructionDataArgs = {};

export function getPatchCustodiesOraclesInstructionDataEncoder(): Encoder<PatchCustodiesOraclesInstructionDataArgs> {
  return transformEncoder(
    getStructEncoder([['discriminator', fixEncoderSize(getBytesEncoder(), 8)]]),
    (value) => ({
      ...value,
      discriminator: PATCH_CUSTODIES_ORACLES_DISCRIMINATOR,
    })
  );
}

export function getPatchCustodiesOraclesInstructionDataDecoder(): Decoder<PatchCustodiesOraclesInstructionData> {
  return getStructDecoder([
    ['discriminator', fixDecoderSize(getBytesDecoder(), 8)],
  ]);
}

export function getPatchCustodiesOraclesInstructionDataCodec(): Codec<
  PatchCustodiesOraclesInstructionDataArgs,
  PatchCustodiesOraclesInstructionData
> {
  return combineCodec(
    getPatchCustodiesOraclesInstructionDataEncoder(),
    getPatchCustodiesOraclesInstructionDataDecoder()
  );
}

export type PatchCustodiesOraclesInput<
...
export function getPatchCustodiesOraclesInstruction<
  TAccountAdmin extends string,
  TAccountPool extends string,
  TAccountCortex extends string,
  TAccountUsdcCustody extends string,
...
>(
  input: PatchCustodiesOraclesInput<
    TAccountAdmin,
    TAccountPool,
    TAccountCortex,
    TAccountUsdcCustody,
...
): PatchCustodiesOraclesInstruction<
  TProgramAddress,
  TAccountAdmin,
  TAccountPool,
  TAccountCortex,
...
> {
  ...
  const instruction = {
    ...
    programAddress,
    data: getPatchCustodiesOraclesInstructionDataEncoder().encode({}),
  } as PatchCustodiesOraclesInstruction<
    TProgramAddress,
    TAccountAdmin,
    TAccountPool,
    TAccountCortex,
...
export type ParsedPatchCustodiesOraclesInstruction<
  TProgram extends string = typeof ADRENA_PROGRAM_ADDRESS,
...
> = {
  ...
  data: PatchCustodiesOraclesInstructionData;
};

export function parsePatchCustodiesOraclesInstruction<
...
>(
  instruction: IInstruction<TProgram> &
    ...
    IInstructionWithData<Uint8Array>
): ParsedPatchCustodiesOraclesInstruction<TProgram, TAccountMetas> {
  ...
  return {
    ...
    data: getPatchCustodiesOraclesInstructionDataDecoder().decode(
      instruction.data
    ),
  };
}
