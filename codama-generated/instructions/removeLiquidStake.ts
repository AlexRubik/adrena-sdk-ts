...
export const REMOVE_LIQUID_STAKE_DISCRIMINATOR = new Uint8Array([
  105, 41, 117, 216, 103, 113, 176, 174,
]);

export function getRemoveLiquidStakeDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    REMOVE_LIQUID_STAKE_DISCRIMINATOR
  );
}

export type RemoveLiquidStakeInstruction<
...
export type RemoveLiquidStakeInstructionData = {
  discriminator: ReadonlyUint8Array;
  amount: bigint;
};

export type RemoveLiquidStakeInstructionDataArgs = { amount: number | bigint };

export function getRemoveLiquidStakeInstructionDataEncoder(): Encoder<RemoveLiquidStakeInstructionDataArgs> {
  return transformEncoder(
    getStructEncoder([
      ['discriminator', fixEncoderSize(getBytesEncoder(), 8)],
      ['amount', getU64Encoder()],
    ]),
    (value) => ({ ...value, discriminator: REMOVE_LIQUID_STAKE_DISCRIMINATOR })
  );
}

export function getRemoveLiquidStakeInstructionDataDecoder(): Decoder<RemoveLiquidStakeInstructionData> {
...
export function getRemoveLiquidStakeInstructionDataCodec(): Codec<
  RemoveLiquidStakeInstructionDataArgs,
  RemoveLiquidStakeInstructionData
> {
  return combineCodec(
    getRemoveLiquidStakeInstructionDataEncoder(),
    getRemoveLiquidStakeInstructionDataDecoder()
  );
}

export type RemoveLiquidStakeInput<
...
> = {
  ...
  amount: RemoveLiquidStakeInstructionDataArgs['amount'];
};

export function getRemoveLiquidStakeInstruction<
  TAccountOwner extends string,
  TAccountStakedTokenAccount extends string,
  TAccountLmTokenAccount extends string,
  TAccountRewardTokenAccount extends string,
...
> {
  ...
  const instruction = {
    ...
    programAddress,
    data: getRemoveLiquidStakeInstructionDataEncoder().encode(
      args as RemoveLiquidStakeInstructionDataArgs
    ),
  } as RemoveLiquidStakeInstruction<
    TProgramAddress,
    TAccountOwner,
    TAccountStakedTokenAccount,
    TAccountLmTokenAccount,
...
export type ParsedRemoveLiquidStakeInstruction<
  TProgram extends string = typeof ADRENA_PROGRAM_ADDRESS,
...
> = {
  ...
  accounts: {
    ...
    /** #2 */
    stakedTokenAccount: TAccountMetas[1];
    /** #3 */
  ...
  data: RemoveLiquidStakeInstructionData;
};

export function parseRemoveLiquidStakeInstruction<
...
>(
  instruction: IInstruction<TProgram> &
    ...
    IInstructionWithData<Uint8Array>
): ParsedRemoveLiquidStakeInstruction<TProgram, TAccountMetas> {
  ...
  return {
    ...
    data: getRemoveLiquidStakeInstructionDataDecoder().decode(instruction.data),
  };
}
