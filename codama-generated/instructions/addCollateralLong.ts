...
export const ADD_COLLATERAL_LONG_DISCRIMINATOR = new Uint8Array([
  101, 191, 243, 208, 154, 22, 72, 19,
]);

export function getAddCollateralLongDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    ADD_COLLATERAL_LONG_DISCRIMINATOR
  );
}

export type AddCollateralLongInstruction<
...
export type AddCollateralLongInstructionData = {
  discriminator: ReadonlyUint8Array;
  collateral: bigint;
  oraclePrices: Option<ChaosLabsBatchPrices>;
};

export type AddCollateralLongInstructionDataArgs = {
  collateral: number | bigint;
  oraclePrices: OptionOrNullable<ChaosLabsBatchPricesArgs>;
};

export function getAddCollateralLongInstructionDataEncoder(): Encoder<AddCollateralLongInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({ ...value, discriminator: ADD_COLLATERAL_LONG_DISCRIMINATOR })
  );
}

export function getAddCollateralLongInstructionDataDecoder(): Decoder<AddCollateralLongInstructionData> {
...
export function getAddCollateralLongInstructionDataCodec(): Codec<
  AddCollateralLongInstructionDataArgs,
  AddCollateralLongInstructionData
> {
  return combineCodec(
    getAddCollateralLongInstructionDataEncoder(),
    getAddCollateralLongInstructionDataDecoder()
  );
}

export type AddCollateralLongInput<
...
> = {
  ...
  collateral: AddCollateralLongInstructionDataArgs['collateral'];
  oraclePrices: AddCollateralLongInstructionDataArgs['oraclePrices'];
};

export function getAddCollateralLongInstruction<
  TAccountOwner extends string,
  TAccountFundingAccount extends string,
  TAccountTransferAuthority extends string,
  TAccountCortex extends string,
...
> {
  ...
  const instruction = {
    ...
    programAddress,
    data: getAddCollateralLongInstructionDataEncoder().encode(
      args as AddCollateralLongInstructionDataArgs
    ),
  } as AddCollateralLongInstruction<
    TProgramAddress,
    TAccountOwner,
    TAccountFundingAccount,
    TAccountTransferAuthority,
...
export type ParsedAddCollateralLongInstruction<
  TProgram extends string = typeof ADRENA_PROGRAM_ADDRESS,
...
> = {
  ...
  data: AddCollateralLongInstructionData;
};

export function parseAddCollateralLongInstruction<
...
>(
  instruction: IInstruction<TProgram> &
    ...
    IInstructionWithData<Uint8Array>
): ParsedAddCollateralLongInstruction<TProgram, TAccountMetas> {
  ...
  return {
    ...
    data: getAddCollateralLongInstructionDataDecoder().decode(instruction.data),
  };
}
