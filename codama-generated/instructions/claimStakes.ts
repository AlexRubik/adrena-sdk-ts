...
export const CLAIM_STAKES_DISCRIMINATOR = new Uint8Array([
  254, 140, 24, 53, 197, 234, 35, 121,
]);

export function getClaimStakesDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    CLAIM_STAKES_DISCRIMINATOR
  );
}

export type ClaimStakesInstruction<
...
export type ClaimStakesInstructionData = {
  discriminator: ReadonlyUint8Array;
  lockedStakeIndexes: Option<ReadonlyUint8Array>;
};

export type ClaimStakesInstructionDataArgs = {
  lockedStakeIndexes: OptionOrNullable<ReadonlyUint8Array>;
};

export function getClaimStakesInstructionDataEncoder(): Encoder<ClaimStakesInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({ ...value, discriminator: CLAIM_STAKES_DISCRIMINATOR })
  );
}

export function getClaimStakesInstructionDataDecoder(): Decoder<ClaimStakesInstructionData> {
...
export function getClaimStakesInstructionDataCodec(): Codec<
  ClaimStakesInstructionDataArgs,
  ClaimStakesInstructionData
> {
  return combineCodec(
    getClaimStakesInstructionDataEncoder(),
    getClaimStakesInstructionDataDecoder()
  );
}

export type ClaimStakesInput<
...
> = {
  ...
  lockedStakeIndexes: ClaimStakesInstructionDataArgs['lockedStakeIndexes'];
};

export function getClaimStakesInstruction<
  TAccountCaller extends string,
  TAccountPayer extends string,
  TAccountOwner extends string,
  TAccountRewardTokenAccount extends string,
...
> {
  ...
  const instruction = {
    ...
    programAddress,
    data: getClaimStakesInstructionDataEncoder().encode(
      args as ClaimStakesInstructionDataArgs
    ),
  } as ClaimStakesInstruction<
    TProgramAddress,
    TAccountCaller,
    TAccountPayer,
    TAccountOwner,
...
export type ParsedClaimStakesInstruction<
  TProgram extends string = typeof ADRENA_PROGRAM_ADDRESS,
...
> = {
  ...
  data: ClaimStakesInstructionData;
};

export function parseClaimStakesInstruction<
...
>(
  instruction: IInstruction<TProgram> &
    ...
    IInstructionWithData<Uint8Array>
): ParsedClaimStakesInstruction<TProgram, TAccountMetas> {
  ...
  return {
    ...
    data: getClaimStakesInstructionDataDecoder().decode(instruction.data),
  };
}
